...
class Stories extends StatelessWidget {
  ...
  final String toUserUsernameController;
  Stories(
      this.toUserIdController,
      this.toUserNameController,
      this.toUserAvatarController,
      this.toUserBadgeController,
      this.toUserUsernameController,
      {Key key10})
      : super(key: key10);
